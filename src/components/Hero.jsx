    ...
    >
      ...
      <div className="z-10 text-center text-white">
        <h1 className="text-6xl font-semibold mb-6 leading-tight font-roboto-slab">
          <span className="text-green-400 font-bold">EFFORTLESS</span> ONLINE
          INCOME SYSTEM:
          <br />
          YOUR PATH TO{" "}
        ...
        <p className="font-nunito w-100 mb-16 text-white md:text-xl md:w-1/2 md:mx-auto">
          Ready to transform into a savvy Forexpreneur? Join us on a learning
          adventure that unlocks the secrets of Forex and online business
          success. Enroll now in our comprehensive courses under our{" "}
          <span className="font-bold underline">
            Financial Freedom Project Program
          </span>{" "}
          and embark on a journey towards financial prosperity!
        </p>
        <a

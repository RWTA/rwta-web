...
import { faChartLine, faLightbulb, faRocket } from '@fortawesome/free-solid-svg-icons'
      ...
      <div className="max-w-6xl mx-auto px-4 mt-10">
        <div className="flex justify-center items-stretch space-x-7">
          <div className="w-1/3 box border-blue-200 flex flex-col justify-between">
            ...
            <div>
              <h3 className="subheader-1 font-bold my-5 text-2xl">Learn The Ultimate Trading</h3>
              <p className="par-1 text-lg">Discover how to trade successfully and make the most of opportunities.</p>
            </div>
          </div>
          <div className="w-1/3 box border-blue-200 flex flex-col justify-between">
            <div className="w-20 mx-auto h-20 bg-blue-500 rounded-full flex items-center justify-center">
            ...
            <div>
              <h3 className="subheader-1 font-bold my-5 text-2xl">Start Your Trading Journey</h3>
              <p className="par-1 text-lg">Join us to gain the skills and mindset for successful trading</p>
            </div>
          </div>
          <div className="w-1/3 box border-blue-200 flex flex-col justify-between">
            <div className="w-20 mx-auto h-20 bg-blue-500 rounded-full flex items-center justify-center">
            ...
            <div>
              <h3 className="subheader-1 font-bold my-5 text-2xl">Master Trading, Boost Your Finances</h3>
              <p className="par-1 text-lg">Learn practical trading strategies to shape your financial future</p>
            </div>
          </div>
        </div>

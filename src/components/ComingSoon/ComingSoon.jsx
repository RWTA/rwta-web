    ...
    <div className="flex flex-col justify-center items-center h-screen" style={{
      ...
      <div className="coming-soon-wrap">
        ...
        <div className="coming-soon-content text-center">
          <h1 className="text-red-700 font-bold text-4xl mb-5">SOMETHING <span className="text-green-600">EXTRAORDINARY</span> IS IN THE WORKS!</h1>
          <hr className="my-5" />
          <p className="w-100 text-gray-800 text-lg md:w-8/12 md:mx-auto">We're hard at work constructing the future of forex education. Stay tuned for a transformative learning experience!</p>
        </div>
